        ...
        <form onSubmit={handleSubmit(onSubmit)} className="block" id="block">
          {tapValue === "Basic Info" && (
            <div className="px-6 pt-8 flex-grow w-full h-full max-h-full pb-40 md:pb-32 lg:pb-32 xl:pb-32">
              ...
              <div className="grid grid-cols-6 gap-3 md:gap-5 xl:gap-6 lg:gap-6 mb-6">
                <LabelArea label={t("Product Category")} />
                <div className="col-span-8 sm:col-span-4">
                  <InputArea
                  {...register(`category`, {
              ...
              <div className="grid grid-cols-6 gap-3 md:gap-5 xl:gap-6 lg:gap-6 mb-6">
                <LabelArea label={t("Product Sub Category")} />
                <div className="col-span-8 sm:col-span-4">
                  <InputArea
                  {...register(`subCategory`, {
                    ...
                    name="subCategory"
                    type="text"
                    placeholder={t("Product Sub Category")}
                  />
              ...
              <div className="grid grid-cols-6 gap-3 md:gap-5 xl:gap-6 lg:gap-6 mb-6">
                <LabelArea label={t("Product Manufacturing Date")} />
                <div className="col-span-8 sm:col-span-4">
                  <InputArea
                    register={register}
                    required={true}
                    ...
                    type="date"
                    placeholder={t("Product Manufacturing Date")}
                  />
                  <Error errorName={errors.barcode} />
                </div>
              </div>
              ...
              <div className="grid grid-cols-6 gap-3 md:gap-5 xl:gap-6 lg:gap-6 mb-6">
                <LabelArea label={t("Product Expiry Date")} />
                <div className="col-span-8 sm:col-span-4">
                  <InputArea
                    register={register}
                    label={t("Product Expiry Date")}
                    name="expiryDate"
                    required={true}
                    type="date"
                    placeholder={t("Product Expiry Date")}
                  />
                  <Error errorName={errors.barcode} />
                </div>
              </div>
